...
# test project build configuration file
...
linkcheck_ignore = [
    ...
    r"https://github.com/collective/testproject/issues/new",  # requires auth
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/collective/testproject",
    ...
    "repository_url": "https://github.com/collective/testproject",
...
# html_context = {
#     "edit_page_url_template": "https://github.com/collective/testproject/edit/main/docs/",
# }
...
ogp_site_name = "test project Documentation"
ogp_type = "website"
...
htmlhelp_basename = "test projectDocumentation"
