...
2. Go to your repository at [collective/test-project](https://github.com/collective/test-project).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `test-project.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | test-project.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | test-project.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/test-project/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/test-project/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/test-project-backend`) and Frontend (`ghcr.io/collective/test-project-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of test-project.example.com](https://github.com/collective/test-project/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/test-project.example.com.yml` stack.
