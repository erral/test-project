...
stack-start:  ## Local Stack: Start Services
	...
	@echo "Now visit: http://test-project.localhost"
...
acceptance-frontend-image-build:
	...
	@docker build frontend -t collective/test-project-frontend:acceptance -f frontend/Dockerfile --build-arg VOLTO_VERSION=$(VOLTO_VERSION)

.PHONY: acceptance-backend-image-build
acceptance-backend-image-build:
	@echo "Build acceptance backend image"
	@docker build backend -t collective/test-project-backend:acceptance -f backend/Dockerfile.acceptance --build-arg PLONE_VERSION=$(PLONE_VERSION)
